...
public class TestClassObject04 {
	...
	public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
		...
		/*显示加载*/
//		classLoader.loadClass("cn.gcjlearn.java.base.classloader.Class0401");

//		Class.forName("cn.gcjlearn.java.base.classloader.Class0401");
//		Class.forName(
//				"cn.gcjlearn.java.base.classloader.Class0402",
//				true,
//				classLoader);
